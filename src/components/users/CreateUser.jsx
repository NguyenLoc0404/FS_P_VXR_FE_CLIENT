    ...
    api.post("/users", credentials)
        ...
        .catch(err => {
            if (err.response.data.email)
                swal(`${err.response.data.email}`)
            else if (err.response.data.fullName)
                swal(`${err.response.data.fullName}`)
            else if (err.response.data.password)
                swal(`${err.response.data.password}`)
            else if (err.response.data.password2)
                swal(`${err.response.data.password2}`)
        });
};
